...
export default function VerifyEmail() {
  ...
  const [cooldown, setCooldown]   = useState(0); // seconds remaining before allow resend
  ...
  const handleResend = async () => {
    ...
    if (result.success) {
      ...
      toast.error(result.message || "Could not resend code. Try again later.");
    }
  };
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-8">
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-xl overflow-hidden grid lg:grid-cols-2">
        ...
        <div className="relative bg-gradient-to-br from-primary via-secondary to-primary text-white p-16 flex flex-col justify-between">
          ...
          <div>
            <h4 className="text-xl font-semibold mb-4">Almost there! ✉️</h4>
        ...
        <div className="p-12 flex items-center">
          <div className="w-full">
            ...
            <h2 className="text-4xl text-gray-800 font-bold mb-1">Enter code</h2>
            <p className="text-gray-500 mb-6">
              Check your inbox{emailFromState ? ` at ${emailFromState}` : ""} for the verification code.
            </p>

            <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">

              {/* Email input — show if not passed via state */}
              {!emailFromState && (
                <div>
                  ...
                  <input
                    type="email"
                    className="w-full border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 text-gray-800"
              ...
              <div className="flex items-center justify-center gap-2 text-sm text-gray-500">
                ...
                <button
                  ...
                  className="flex items-center gap-1 font-semibold text-primary hover:underline disabled:opacity-50 disabled:no-underline disabled:cursor-not-allowed"
                >
                  {resending ? (
