      ...
      <div className="min-h-screen bg-gray-100 flex items-center justify-center p-8">
        <div className="w-full max-w-5xl bg-white rounded-3xl shadow-xl overflow-hidden grid lg:grid-cols-2">
          <div className="relative bg-gradient-to-br from-primary via-secondary to-primary text-white p-16 flex flex-col justify-between">
            ...
            <div>
              <h4 className="text-xl font-semibold mb-4">Check your inbox 📬</h4>
              <h1 className="text-5xl font-bold leading-tight">Code Sent!</h1>
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-8">
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-xl overflow-hidden grid lg:grid-cols-2">
        ...
        <div className="relative bg-gradient-to-br from-primary via-secondary to-primary text-white p-16 flex flex-col justify-between">
          ...
          <div>
            <h4 className="text-xl font-semibold mb-4">Forgot your password? 🔑</h4>
        ...
        <div className="p-12 flex items-center">
          <div className="w-full">
            <h2 className="text-4xl text-gray-800 font-bold mb-1">Forgot password</h2>
